          ...
          <BrowserRouter>
            <Suspense fallback={<Loading />}>
              <Routes>
                ...
                <Route path="/withdrawal" element={<RedirectPage seoTitle="TekkaBuzz Withdrawal" canonicalPath="/withdrawal" seoDesc="Withdraw your winnings from TekkaBuzz." seoKeywords={`tekkabuzz withdrawal, ${BASE_KW}`} affiliatePath="/af/9oI2NL83/tekkabuzz%20in" />} />
                <Route path="/payment" element={<RedirectPage seoTitle="TekkaBuzz Payment" canonicalPath="/payment" seoDesc="TekkaBuzz payment methods." seoKeywords={`tekkabuzz payment, ${BASE_KW}`} affiliatePath="/af/9oI2NL83/tekkabuzz%20in" />} />
                ...
                <Route path="/live-dealer" element={<RedirectPage seoTitle="TekkaBuzz Live Dealer" canonicalPath="/live-dealer" seoDesc="Live dealer games at TekkaBuzz." seoKeywords={`tekkabuzz live dealer, ${BASE_KW}`} affiliatePath="/af/9oI2NL83/tekkabuzz%20casino" />} />

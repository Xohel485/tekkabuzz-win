      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-14 lg:h-16 gap-3">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            <Link
              to="/login"
              className="px-3 py-1.5 text-sm font-semibold border border-primary text-primary rounded-lg hover:bg-primary hover:text-primary-foreground active:scale-95 transition-all whitespace-nowrap"
            ...
            <Link
              to="/signup"
              className="px-3 py-1.5 text-sm font-bold bg-primary text-primary-foreground rounded-lg hover:brightness-110 active:scale-95 transition-all whitespace-nowrap gold-shimmer"
